...
type ParseRecord struct {
	...
	CoverUrl string `json:"cover_url" gorm:"type:varchar(300);comment:视频封面地址"`
	MusicUrl string `json:"music_url" gorm:"type:varchar(300);comment:音乐播放地址"`
	VideoURL string `json:"video_url" gorm:"type:varchar(300);comment:视频播放地址"`
}
