  ...
  <view class="p-4 space-y-4">
    ...
    <view class="bg-white rounded-xl p-4 shadow-sm">
      <view class="grid grid-cols-4 gap-4">
        <view v-for="item in actions" :key="item.type" class="flex flex-col items-center" @tap="handleAction(item.type)">
          <view :class="['w-12 h-12 rounded-xl flex items-center justify-center mb-2', item.bgColor]">
